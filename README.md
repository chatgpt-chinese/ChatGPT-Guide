...
在国内能轻松使用 [**ChatGPT 中文版**](https://ai.lanjingai.org)，**无需翻墙**，**支持 GPT-5、4o、o1 及中文版功能**。   
...
- [https://ai.lanjingai.org](https://ai.lanjingai.org/) - **ChatGPT 中文站**，支持 GPT-5、4o、o1、o3 及 Gemini 2.5 Pro、Claude 4 sonnet、Grok 4 最先进的模型，无限使用~
